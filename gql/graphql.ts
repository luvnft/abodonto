...
/**
 * __useTextPageQuery__
 *
 * To run a query within a React component, call `useTextPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useTextPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTextPageQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useTextPageQuery(baseOptions: Apollo.QueryHookOptions<TextPageQuery, TextPageQueryVariables> & ({ variables: TextPageQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TextPageQuery, TextPageQueryVariables>(TextPageDocument, options);
      }
export function useTextPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TextPageQuery, TextPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TextPageQuery, TextPageQueryVariables>(TextPageDocument, options);
        }
export function useTextPageSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TextPageQuery, TextPageQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TextPageQuery, TextPageQueryVariables>(TextPageDocument, options);
        }
export type TextPageQueryHookResult = ReturnType<typeof useTextPageQuery>;
export type TextPageLazyQueryHookResult = ReturnType<typeof useTextPageLazyQuery>;
export type TextPageSuspenseQueryHookResult = ReturnType<typeof useTextPageSuspenseQuery>;
export type TextPageQueryResult = Apollo.QueryResult<TextPageQuery, TextPageQueryVariables>;